...
**Test patterns:**
```
Search for files: **/*.test.*, **/*.spec.*, **/test_*.py, **/*_test.go
```
...
```
Search for files: specs/*/plan.md, .specify/specs/**/plan.md
```
...
```
Search for files: <each file path listed as MODIFY>
```
