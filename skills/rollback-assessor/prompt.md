...
```
Search for files: **/migrations/*, **/migrate/*, **/db/migrate/*, **/alembic/versions/*, **/flyway/*, **/liquibase/*
```
...
```
Search for content: "def down", "def change", "reversible", "down()", "rollback" in migration files
```
...
```
Search for content: "api/", "endpoint", "fetch(", "axios.", "httpClient" across the codebase
Search for files: **/client/*, **/sdk/*, **/consumer/*
```
...
```
Search for files: **/feature*, **/flags.*, **/toggles.*
```
...
### State Store Changes
```
Search for content: "redis", "cache", "session", "queue", "kafka", "stream" in changed files
```
