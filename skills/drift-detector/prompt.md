...
```
Search for files: specs/<NNN>-<slug>/spec.v*.md
...
```
Search for files: specs/<NNN>-<slug>/spec-review*.md
Search for files: specs/<NNN>-<slug>/spec-fix-*.md
Search for files: reports/review-fix-*-<slug>*.md
Search for files: specs/<NNN>-<slug>/gate-*.md
Search for files: specs/<NNN>-<slug>/triage-log.json
```
...
```
Search for files: specs/*/spec.md — all specs in the project
Search for files: specs/*/plan.md — all plans
