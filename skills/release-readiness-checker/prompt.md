...
```
Search for files: CHANGELOG.md, CHANGES.md, HISTORY.md, docs/changelog*
```
...
```
Search for content: "TODO.*release", "FIXME.*release", "HACK.*before.*release", "XXX"
Search for content: "TODO.*$RELEASE", "FIXME.*block"
```
