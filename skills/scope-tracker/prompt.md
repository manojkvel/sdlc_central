...
```
Search for files: specs/*/spec.v*.md
...
```
Search for files: specs/*/children/ or linked child specs in spec YAML
For each child spec:
...
```
Search for files: specs/*/pipeline-state.json
...
```
Search for files: specs/*/spec-review*.md
