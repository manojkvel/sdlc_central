...
```
Search for content: "<error-message-keywords>" in the codebase
```
...
```
Search for content: "import.*<failing-module>", "require.*<failing-module>", "from.*<failing-module>"
```
...
```
Search for files: **/.env*, **/config.*, **/settings.*, docker-compose.y*
Search for content: "<relevant-config-key>"
```
