...
```
Search for files: .azure-pipelines/**/*.yml, .github/**/*.yml, .gitlab-ci.yml
Search for content: "branch_protection", "protected_branches", "rules"
```
...
```
Search for files: .github/PULL_REQUEST_TEMPLATE*, .azuredevops/pull_request_template*, docs/pull_request_template*
```
...
```
Search for files: azure-pipelines*.yml, .azure-pipelines/**/*.yml, .github/workflows/*.yml, .gitlab-ci.yml, Jenkinsfile, .circleci/config.yml
```
...
```
Search for content: "serviceConnection", "service_connection", "credentials", "azureSubscription"
Search for content: "AWS_ACCESS_KEY", "AZURE_", "GCP_", "DOCKER_"
```
...
```
Search for files: **/environments/*, **/env/*, **/deploy/*
Search for content: "environment:", "deployment:", "stage:"
```
...
```
Search for files: .env*, **/.env*, **/env.*, **/config/env*
```
...
```
Search for content: "admin", "owner", "bypass", "skip.*approval", "override"
```
