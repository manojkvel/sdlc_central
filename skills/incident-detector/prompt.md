...
```
Search for files: logs/*, **/error.log, **/app.log
Search for content: "ERROR", "FATAL", "CRITICAL", "Exception", "panic:", "Traceback"
Search for content: "OOMKilled", "CrashLoopBackOff", "connection refused", "timeout"
```
...
```
Search for files: **/health*, docker-compose.y*, k8s/**/*.y*, **/readiness*, **/liveness*
```
...
```
Search for files: .github/workflows/*, .azure-pipelines/*, azure-pipelines.yml, Jenkinsfile
```
Check for recently failed pipeline runs if CI artifacts are available.

### Monitoring Configuration
```
Search for files: **/prometheus*, **/alertmanager*, **/grafana*, **/alerts.y*, **/rules.y*
```
Read alert rules to understand what thresholds the team considers critical.

### Existing Incident Reports
```
Search for files: reports/incident-*, reports/postmortem-*, docs/incidents/*
```
