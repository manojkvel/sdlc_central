...
```
Search for files: **/vendor/**/{LICENSE,COPYING,NOTICE}
Search for files: **/third_party/**/{LICENSE,COPYING,NOTICE}
Search for files: **/bundled/**/{LICENSE,COPYING,NOTICE}
```

### Copy-Pasted Code with License Headers
Search source files for embedded license comments:
```
Search for content: "Copyright.*All rights reserved"
Search for content: "Licensed under the"
Search for content: "SPDX-License-Identifier:"
```

### Fonts, Images, and Assets
Check for non-code assets with restrictive licenses:
```
Search for files: **/*.ttf, **/*.otf, **/*.woff, **/*.woff2
Search for files: **/assets/{LICENSE,NOTICE,CREDITS}
```
