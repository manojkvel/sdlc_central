...
```
Search for files: package.json, tsconfig.json, pyproject.toml, requirements*.txt,
...
```
Search for content: encrypt, decrypt, hash, audit_log, access_log, consent,
...
```
Search for files: .claude/skills/*/SKILL.md
```
