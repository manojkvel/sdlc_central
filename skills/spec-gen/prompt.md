...
```
Search for files: CLAUDE.md, specs/*.md, .specify/specs/**/*.md, docs/specs/**/*.md
```

Check if there are existing specs to understand the format and domain language used by this team.

```
Search for files: package.json, pyproject.toml, go.mod, Cargo.toml
```
...
```
Search for files: specs/*/spec.md, .specify/specs/**/spec.md
```
