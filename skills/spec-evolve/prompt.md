...
```
Search for files: specs/<NNN>-<slug>/spec.md
Search for files: specs/<NNN>-<slug>/spec.v*.md        (existing versions)
Search for files: specs/<NNN>-<slug>/plan.md            (downstream: plan)
Search for files: specs/<NNN>-<slug>/tasks.md           (downstream: tasks)
Search for files: specs/<NNN>-<slug>/board-mapping.json (downstream: board)
Search for files: specs/<NNN>-<slug>/spec-review.md     (trigger source if spec-review)
Search for files: specs/<NNN>-<slug>/children/          (existing child specs)
Search for files: reports/task-implementer-*-<slug>*.md (implementation state)
```
